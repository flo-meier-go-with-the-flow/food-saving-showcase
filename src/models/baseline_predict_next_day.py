...
if __name__ == '__main__':
    ...
    num_features = ['num_people_10_00']  # ,'temp_deviation', 'Temperature', 'Rain Duration']
    cat_features = []  # 'weekday']
    cat_features_onehot = []  # 'w0','w1','w2','w3','w4']
    bin_features = []  # 'Rain_binary','Spring/Autumn','Summer','Winter','zurich_vacation', 'zuehlke_day']
    ...
    search_space_elastic_net = {
        'alpha': hp.loguniform('alpha', -5, 5),  # if I understood this correctly it returns a value beteen e^a and e^b
    ...
    mlflow.set_experiment('elastic_net_experimentation')  # 'elastic_net_experimentation','elastic_net_label_12_20','elastic_net_label_11_30','elastic_net_label_num_menu_sold'
