...
if __name__ == '__main__':
    ...
    num_features = ['exp_moving_avg_0.2']  # 'exp_moving_avg_0.1','average_of_past_weeks','deviation_1_day_ago','deviation_2_day_ago','temp_deviation', 'Temperature', 'Rain Duration','Rain_half_discrete'
    cat_features = []  # 'weekday']
    cat_features_onehot = []  # 'w0','w1','w2','w3','w4']
    bin_features = ['month_quarter_0','month_quarter_1','month_quarter_2','month_quarter_3','zuehlke_day','Spring/Autumn','Summer','Winter']  # 'Rain_binary','Spring/Autumn','Summer','Winter','zurich_vacation', 'zuehlke_day', 'Monday','Tuesday','Wednesday','Thursday','Friday','month_quarter_0'(1,2,3)
    label = ['label_num_people_11_30']  # 'label_num_people_11_30','label_num_people_12_33','label_num_menus_sold'
    ...
    mlflow.set_experiment('future_days:experimentation')  #'future_days:experimentation','future_days:label_num_menus_sold_experimentation', 'elastic_net_experimentation','elastic_net_label_12_20','elastic_net_label_11_30','elastic_net_label_num_menu_sold'
